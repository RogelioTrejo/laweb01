package com.rst.ms.proyectos.controllers;
...
import com.rst.ms.proyectos.services.InvestigadorService;
...
public class InvestigadorController {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity <?> eliminarInvestigador(@PathVariable Long id) throws IllegalOperationException{
